...
export PWD="/home/S12307/mpi_programs/lab2"
export SHELL="/bin/bash"
export SHLVL="2"
export SSH_CLIENT="192.168.64.155 20908 22"
export SSH_CONNECTION="192.168.64.155 20908 192.168.64.197 22"
export SSH_TTY="/dev/pts/12"
export TERM="xterm"
export USER="s12307"
export XDG_RUNTIME_DIR="/run/user/12307"
export XDG_SESSION_ID="685"
EnvCommandLine=(
)
num_nodes=2
hosts_list="$2"
...
np=9
tview_flag=
progname="$5 /home/S12307/mpi_programs/lab2/main"
mpich_args=""
cmdLineArgs=""
...
cd "/home/S12307/mpi_programs/lab2"
...
if [  "" ] ;then
  ...
  /common/runmvs/bin/genmachinefile "$hosts_list" $machine_file 9 >$gentmpname
