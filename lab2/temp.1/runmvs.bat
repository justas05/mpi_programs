...
export OLDPWD
export PATH="/usr/runmvs/bin:/common/runmvs/bin:/common/runmvs/sbin:/common/mpich/bin:/usr/local/bin:/bin:/usr/bin:/usr/local/sbin:/usr/sbin"
...
np=8
tview_flag=
progname="$5 /home/S12307/mpi_programs/lab2/temp"
mpich_args=""
cmdLineArgs=""
