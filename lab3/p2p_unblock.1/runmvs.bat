...
export PWD="/home/S12307/mpi_programs/lab3"
export SHELL="/bin/bash"
export SHLVL="2"
export SSH_CLIENT="192.168.64.155 20685 22"
export SSH_CONNECTION="192.168.64.155 20685 192.168.64.197 22"
export SSH_TTY="/dev/pts/10"
export TERM="xterm"
export USER="s12307"
export XDG_RUNTIME_DIR="/run/user/12307"
export XDG_SESSION_ID="684"
EnvCommandLine=(
)
num_nodes=1
hosts_list="$2"
...
np=2
tview_flag=
progname="$5 /home/S12307/mpi_programs/lab3/p2p_unblock"
mpich_args=""
cmdLineArgs=""
...
cd "/home/S12307/mpi_programs/lab3"
...
if [  "" ] ;then
  ...
  /common/runmvs/bin/genmachinefile "$hosts_list" $machine_file 2 >$gentmpname
