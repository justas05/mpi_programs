...
export PWD="/home/S12307/mpi_programs/allreduce_blocked"
export SHELL="/bin/bash"
export SHLVL="2"
export SSH_CLIENT="192.168.64.155 36796 22"
export SSH_CONNECTION="192.168.64.155 36796 192.168.64.197 22"
...
np=5
tview_flag=
progname="$5 /home/S12307/mpi_programs/allreduce_blocked/./main"
mpich_args=""
cmdLineArgs=""
...
cd "/home/S12307/mpi_programs/allreduce_blocked"
...
if [  "" ] ;then
  ...
  /common/runmvs/bin/genmachinefile "$hosts_list" $machine_file 5 >$gentmpname
