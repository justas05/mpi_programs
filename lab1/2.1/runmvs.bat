...
export SHLVL="2"
export SSH_CLIENT="192.168.64.156 40359 22"
export SSH_CONNECTION="192.168.64.156 40359 192.168.64.197 22"
export SSH_TTY="/dev/pts/0"
export TERM="xterm"
export USER="s12307"
export XDG_RUNTIME_DIR="/run/user/12307"
export XDG_SESSION_ID="530"
EnvCommandLine=(
)
num_nodes=2
hosts_list="$2"
...
np=10
tview_flag=
progname="$5 /home/S12307/mpi_programs/lab1/2"
mpich_args=""
cmdLineArgs=""
