...
export PWD="/home/S12307/mpi_programs/lab1"
export SHELL="/bin/bash"
export SHLVL="2"
export SSH_CLIENT="192.168.64.155 60357 22"
export SSH_CONNECTION="192.168.64.155 60357 192.168.64.197 22"
export SSH_TTY="/dev/pts/10"
export TERM="xterm"
export USER="s12307"
export XDG_RUNTIME_DIR="/run/user/12307"
export XDG_SESSION_ID="448"
EnvCommandLine=(
)
num_nodes=2
hosts_list="$2"
...
np=10
tview_flag=
progname="$5 /home/S12307/mpi_programs/1/first_prog.sh"
mpich_args=""
cmdLineArgs=""
...
cd "/home/S12307/mpi_programs/lab1"
...
if [  "" ] ;then
  ...
  /common/runmvs/bin/genmachinefile "$hosts_list" $machine_file 10 >$gentmpname
