...
export PWD="/home/S12307/mpi_programs/multy_send"
export SHELL="/bin/bash"
export SHLVL="2"
export SSH_CLIENT="192.168.64.166 1541 22"
export SSH_CONNECTION="192.168.64.166 1541 192.168.64.197 22"
export SSH_TTY="/dev/pts/25"
export TERM="xterm"
export USER="s12307"
export XDG_RUNTIME_DIR="/run/user/12307"
export XDG_SESSION_ID="920"
EnvCommandLine=(
)
num_nodes=1
hosts_list="$2"
...
np=8
tview_flag=
progname="$5 /home/S12307/mpi_programs/multy_send/main"
mpich_args=""
cmdLineArgs=""
...
cd "/home/S12307/mpi_programs/multy_send"
